...
const SYNTAX_MODIFIERS = {
    ...
    [SyntaxKind.DecoratorDeclarationStatement]: {
        allowed: 14 /* ModifierFlags.All */,
        required: 2 /* ModifierFlags.Extern */ | 8 /* ModifierFlags.Auto */,
        mutuallyExclusive: [[2 /* ModifierFlags.Extern */, 8 /* ModifierFlags.Auto */]],
    },
    [SyntaxKind.FunctionDeclarationStatement]: {
        allowed: 2 /* ModifierFlags.Extern */ | 4 /* ModifierFlags.Internal */,
